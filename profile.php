...
<meta name="description" content="フォトグラファー種清豊の公式ホームページです。プロフィールページ。これまでの経歴、参加した展覧会、出版物などを掲載。" />
...
<title>PROFILE - YUTAKA TANEKIYO 種清豊 | Photographer</title>
</head>
...
<div id="main">
    ...
    <h1><?php the_title(); ?></h1>
    <div class="contents">
    	<h1><img src="/wp-content/themes/yutakatanekiyo_web/images/tanekiyo.jpg"></h1>
        	<?php the_content(); ?>
	</div><!-- //#contents -->
    <?php endwhile; ?>
</div>
